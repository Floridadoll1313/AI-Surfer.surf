...
export const AISurfer = () => {
  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const config: any = {
        systemInstruction: "You are the OTD AI Surfer, a digital ecosystem architect and guide for the Hatteras Digital Archipelago. You are technical, sophisticated, and helpful. You use oceanic and surfing metaphors where appropriate but remain professional.",
      };
